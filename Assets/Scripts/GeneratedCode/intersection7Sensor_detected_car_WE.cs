...
{
	public class intersection7Sensor_detected_car_WE : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "intersection7Sensor_detected_car_WE(intersection7,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
