...
{
	public class intersection8Sensor_detected_car_WE : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "intersection8Sensor_detected_car_WE(intersection8,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
