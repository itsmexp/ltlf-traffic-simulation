...
{
	public class intersection1Sensor_detected_car_WE : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "intersection1Sensor_detected_car_WE(intersection1,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
