...
{
	public class intersection4Sensor_detected_car_WE : Sensor
	{
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "intersection4Sensor_detected_car_WE(intersection4,objectIndex("+index+"),{0})." + Environment.NewLine;
		}
